...
import br.com.Gabriel.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception { // TUDO QUE TIVER DENTRO DO RUN VAI SER EXECUTADO QUANDO A APP FOR INICIADA
		...
		OrderItem oi1 = new OrderItem(o1, p1, 2, p1.getPrice()); //PEDIDO 1, PRODUTO 1, QUANTIDADE 2, PREÇO DO P1
		...
		Payment pay1 = new Payment(null, Instant.parse("2023-04-20T21:53:07Z"), o1); 
		o1.setPayment(pay1);//Associação de mao dupla em memoria (ASSOCIANDO O PEDIDO O1 COM O PAGAMENTO PAY1
