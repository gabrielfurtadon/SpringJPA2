...
import br.com.Gabriel.services.OrderService;
...
public class OrderResoucer {
	...
	public ResponseEntity<List<Order>> findAll() {
		// Order u = new Order(1L, "Gabriel", "991580417", "gabriel@gmail.com", "gabriel123"); instancção manual mocada, nao precida depois que cria o repository
	...
	public ResponseEntity<Order> findById(@PathVariable Long id)	{ //PARA O SPRING ACEITAR O ID COMO PARAMETRO QUE VAI CHEGAR NA URL
